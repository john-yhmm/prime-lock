...
public class EncryptionForm extends JPanel {
    private JTextField vaultPasscode;
    private int a, b, c;
    ...
    public EncryptionForm() {
        ...
        b = (int) (Math.random() * 10); // 0 to 9
        c = (int) (Math.random() * 10); // 0 to 9
        createInputPanel();
        createButtonPanel();
    }
    ...
    private void createInputPanel() {
        ...
        JLabel hintLabel = new JLabel("Enter vault passcode to encrypt", SwingConstants.CENTER);
        hintLabel.setBorder(new EmptyBorder(0, 0, 20, 0));
        hintLabel.setForeground(Color.GRAY);
        inputPanel.add(hintLabel, BorderLayout.NORTH);

        vaultPasscode = new JTextField(20);
        vaultPasscode.setBorder(new EmptyBorder(10, 0, 10, 0));
        inputPanel.add(vaultPasscode, BorderLayout.CENTER);
    ...
    private void createButtonPanel() {
        ...
        encryptBtn.setPreferredSize(new Dimension(100, 40));
        encryptBtn.setFont(new Font("Arial", Font.PLAIN, 16));
        encryptBtn.addActionListener(e -> {
            // show encrypted code
            String passcode = vaultPasscode.getText();
            String encrypted = EncryptionEngine.encrypt(passcode, a, b, c);
            new DisplayFrame(encrypted);
